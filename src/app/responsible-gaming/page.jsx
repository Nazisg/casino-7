    ...
    return (
        <section className="px-4 py-5 lg:py-10">
            <div className="max-w-6xl mx-auto flex flex-col">
                ...
                <p className=" text-base lg:text-xl text-gray-300 leading-relaxed mb-3 lg:mb-6">
                ...
                <div className="mb-6 lg:mb-12 p-3 lg:p-6 bg-green-600/10 border border-green-600 rounded-lg">
                    ...
                    <p className="text-gray-300 text-sm lg:text-base">Gambling should be an entertaining activity, not a way to make money or solve financial problems. If gambling stops being fun, it's time to take a break. We're here to help you maintain control.</p>
                </div>
                ...
                <div className="">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="rounded-xl border border-[#FFD700] bg-green-500/10 p-3 lg:p-6 text-center">
